...
export default function Home() {
  ...
  useEffect(() => {
    let currentIndex = isDeleting ? skills[currentSkillIndex].length : 0;
  ...
  }, [currentSkillIndex, isDeleting, skills]);
                ...
                <div className="timeline">
                  ...
                  <div className="timeline-item">
                    ...
                    >
                      ...
                      <p>
                        Completed Grasshopper and started solving challenges on
                        CodinGame.
                      </p>
                    </motion.div>
                  </div>
                  ...
                  <div className="timeline-item">
                    ...
                    >
                      ...
                      <p>
                        Completed Harvard&apos;s Introduction to Computer
                        Science.
                      </p>
                      <a
                        href="https://certificates.cs50.io/9a13ae2c-7f89-4ffe-a5c4-9e7e6bcadab2.pdf?size=letter"
                  ...
                  <div className="timeline-item">
                    ...
                    >
                      ...
                      <p>
                        Completed the University of Hong Kong&apos;s course on
                        React development.{" "}
                      </p>
                      <p>
                        Built a restaurant website with json server to keep
                        track of reviews.
                      </p>
                      <a
                        href="https://restauranteconfusion.vercel.app/home"
                        className="certificate-link"
                      >
                        View Demo →
                      </a>
                  ...
                  <div className="timeline-item">
                    ...
                    >
                      ...
                      <p>
                        Built a real-time blog with user management during this
                        course.
                      </p>
                      <a
                        href="https://blogricardo.vercel.app/"
                        className="certificate-link"
                      >
                        View Demo →
                      </a>
                  ...
                  <div className="timeline-item">
                    ...
                    >
                      ...
                      <a
                        href="https://certificates.cs50.io/3ea075ca-3cac-49e2-be29-281d46d5ba94.pdf?size=letter"
                        className="certificate-link"
                      >
                        View Certificate →
                      </a>
          ...
          <div className="projects-grid">
              ...
              <div className="project-content">
                ...
                <div className="project-image-container">
                  <Image
                    ...
                    className="project-image"
                    onMouseEnter={() =>
                      handleThumbnailMouseEnter("/ristorante.jpeg")
                    }
                    onClick={() => handleImageClick("/ristorante.jpeg")}
                  />
                </div>
                <p>
                  Restaurant website with review system and database usage to
                  fetch data
                </p>
                <div className="tech-stack">
                  <span>React</span>
                ...
                <div className="project-links">
                  ...
                  <a
                    href="https://github.com/yourusername/restaurant-project"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    GitHub →
              ...
              <div className="project-content">
                ...
                <div className="project-image-container">
                  <Image
                    ...
                    className="project-image"
                    onMouseEnter={() =>
                      handleThumbnailMouseEnter("/matchdinner.jpeg")
                    }
              ...
              <div className="project-content">
                ...
                <div className="project-image-container">
                  <Image
                    ...
                    className="project-image"
                    onMouseEnter={() =>
                      handleThumbnailMouseEnter("/stockinformation.jpeg")
                    }
                    onClick={() => handleImageClick("/stockinformation.jpeg")}
                  />
                </div>
                <p>
                  Financial data platform with real-time updates and portfolio
                  management
                </p>
                <div className="tech-stack">
                  <span>Next.js</span>
            ...
            >
              <div className="project-content">
                ...
                <p>
                  My PC is not powerfull enough to train it better, but for now,
                  it plays good in the early game but uses random moves in the
                  late game.
                </p>
                <div className="tech-stack">
                  <span>Python</span>
              ...
              <div className="project-content">
                ...
                <div className="project-image-container">
                  <Image
                    ...
                    className="project-image"
                    onMouseEnter={() =>
                      handleThumbnailMouseEnter("/lapr2.jpeg")
                    }
                    onClick={() => handleImageClick("/lapr2.jpeg")}
                  />
                </div>
                <p>
                  An app made in Java to help companies manage their associates
                  and their cars/machines to schedule tasks to manage their
                  gardens.
                </p>
                <div className="tech-stack">
                  <span>Java</span>
