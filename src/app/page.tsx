...
export default function Home() {
  ...
  const skills = useMemo(() => t('hero.skills'), [t]);
  ...
  return (
	...
	<div className="about-section" id="about">
          ...
          <div className="about-content">
            ...
            >
              <h3 className="milestones-title">{t('about.milestones.title')}</h3>

              <div className="timeline">
                {t('about.milestones.items').map((milestone: string, index: number) => (
      ...
      <SkillsSection />
        ...
        <div className="projects-container">
          ...
          <div className="projects-grid">
            {t('projects.items').map((project: string, index: number) => (
              <motion.div
                key={index}
